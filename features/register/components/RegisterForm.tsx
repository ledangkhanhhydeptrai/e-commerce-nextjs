...
export default function RegisterForm({
  ...
  return (
    <div className="bg-linear-to-br from-violet-50 via-purple-50 to-fuchsia-50 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative bg-linear-to-br from-violet-600 via-purple-600 to-fuchsia-600 p-12 text-white overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-12">
                  ...
                  <h1 className="text-4xl font-bold mb-3">Phone Sale AI</h1>
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                  ...
                  <p className="text-white/90 mb-4 italic leading-relaxed">
                    Sản phẩm tuyệt vời! Giao diện đẹp, dễ sử dụng và hỗ trợ
                    nhiệt tình. Đã mua 3 chiếc điện thoại!
                  </p>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="relative">
                      <div className="w-24 h-24 rounded-full bg-linear-to-br from-violet-100 to-fuchsia-100 flex items-center justify-center overflow-hidden border-4 border-white shadow-lg">
                        {imagePreview ? (
                          <Image
                            src={imagePreview}
                            width={300}
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="w-full px-6 py-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-purple-400 hover:bg-purple-50 transition-all duration-200 flex items-center justify-center gap-2 group"
                        disabled={loading}
                      >
                        {imagePreview ? (
                          <>
